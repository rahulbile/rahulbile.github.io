...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".strike-overlay {\n  position: fixed;\n  background-color: rgba(0, 0, 0, 0.8);\n  display: none;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  height: 100%;\n  width: 100%;\n  z-index: 999;\n  font-family: 'Lato', 'Helvetica', 'Arial', 'Sans-Serif', sans-serif;\n}\n\n#paymentInfo,\n#QrSlider,\n#paymentRequestRefresh,\n#paymentRequestInvoiceCopy {\n  display: none;\n}\n\n/* Strike Button Styling */\n.strike-btn {\n box-sizing: border-box;\n margin: 0px 0px 12px;\n min-width: 0px;\n appearance: none;\n display: inline-block;\n text-align: center;\n text-decoration: none;\n border: 1px solid rgb(255, 255, 255);\n font-family: Montserrat, system-ui, sans-serif;\n line-height: 1.4;\n font-weight: 700;\n color: rgb(255, 255, 255);\n font-size: 13px;\n outline: none;\n border-radius: 30px;\n padding: 15px 35px;\n cursor: pointer;\n width: 100%;\n}\n\n.qrCodeExpired {\n  filter: blur(2px);\n  background-color: rgba(0, 0, 0, 0.5);\n}\n\n#paymentInfo {\n  color: rgb(253, 152, 0);\n}\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(402);
    ...
    value: function paymentRequest(data) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        window.fetch("".concat(apiUrl, "/invoices"), payload).then(Api.checkStatus).then(function (response) {
          ...
          Util.logDebug("Api.paymentRequest err: ".concat(err.message), err);
          reject(err);
        });
      });
    }
...
;// CONCATENATED MODULE: ./src/lib/payment.js
  ...
  payment_createClass(Payment, [{
    ...
    value: function handleSubmit() {
      ...
      return this.process().then(function () {
        return Util.logDebug('payment.handleSubmit: success');
      })["catch"](function (err) {
        return Util.logError("payment.handleSubmit: error: ".concat(err.message), err);
      });
    }
    /**
    ...
    value: function process() {
      return new Promise(function (resolve, reject) {
        ...
        api.paymentRequest(payParams).then(function (res) {
          ...
          Util.logDebug("payment.process: payment request failed: ".concat(err.message), err);
          var errorMsg = "<b>Something went wrong, please try again after some time.</b>";
...
var Dom = /*#__PURE__*/function () {
  ...
  dom_createClass(Dom, null, [{
    key: "setAmountListener",

    /**
     * Set amount listener
     */
    value: function setAmountListener() {}
    /**
     * Get an element
     */
    ...
    value: function getElementLength(element) {
    ...
    value: function getElementValue(element) {
      ...
      if (elementType === 'radio') {
        ...
        var elementValue = $(element.selector).val();
    ...
    key: "generateQrCode",
    value: function generateQrCode(params) {
      ...
      if (params.lnInvoice) {
        var lnOptions = lodash_default().assign(QRCodeOptions, {
          text: "lightning:".concat(params.lnInvoice)
        });
      ...
      var lnInvoice = document.getElementById('lnQrcode').title;
      ...
      if (params.onchainAddress) {
        $(document).on("click", 'li[data-slide="1"]', function () {
          $('#paymentRequestInvoiceCopy').html('Copy');
          var chainInvoice = document.getElementById('onChainQrcode').title;
    ...
    value: function navigateTo(page) {
      Util.logDebug("Dom.navigateTo: ".concat(page));
...
var loglevel = __webpack_require__(43);
...
var Util = /*#__PURE__*/function () {
  ...
  util_createClass(Util, null, [{
    ...
    value: function logDebug(msg, obj) {
      loglevel_default().debug('logDebug:', msg, obj);
    }
  }, {
    key: "logError",
    value: function logError(msg, obj) {
      loglevel_default().error('logError:', msg, obj);
    }
  }, {
    key: "logInfo",
    value: function logInfo(msg, obj) {
      loglevel_default().info('logInfo:', msg, obj);
    }
  }, {
    key: "startLoading",
    ...
    key: "createErrorOverlay",
    value: function createErrorOverlay() {
    ...
    key: "getPageFields",
    value: function getPageFields(config) {
      var fields = {}; // loop through all supported fields types and add to the list

      var supportedFields = Util.getFields();
      Object.keys(supportedFields).forEach(function (field) {
    ...
    value: function init(config) {
      return new Promise(function (resolve, reject) {
        ...
        if ($(config.submitButton).length !== 1) {
          Util.logInfo("strikeJS configuration error: submitButton ".concat(config.submitButton, " not found"));
        } // Check each required key


        requiredKeys.forEach(function (requiredKey) {
          if (typeof config[requiredKey] === 'undefined') {
            return reject("Configuration error: Unable to find key ".concat(requiredKey));
          }

          return null;
        });
        var payment = new Payment(); // Add predefined fields

        sjs.fields = Util.getPageFields(config); // Attach the creditcard submit button

        $(config.submitButton).on('click', function (event) {
          event.preventDefault();
          return payment.handleSubmit();
        });
        sjs.config = config; // Create a variations array if it's not there

        if (!config.variations) {
          config.variations = [];
        }

        sjs._pageConfigs = {}; // Initialze the payment methods
...
;// CONCATENATED MODULE: ./src/lib/strike.js
 ...
 * @returns {Promise}
 */
function StrikeJS(config) {
  strike_classCallCheck(this, StrikeJS);

  if (typeof config.debug !== 'undefined' && config.debug) {
    loglevel_default().setLevel('debug');
  } else {
    loglevel_default().setLevel('info');
  }
...
;// CONCATENATED MODULE: ./src/lib/bootstrap.js
function bootstrap_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function bootstrap_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function bootstrap_createClass(Constructor, protoProps, staticProps) { if (protoProps) bootstrap_defineProperties(Constructor.prototype, protoProps); if (staticProps) bootstrap_defineProperties(Constructor, staticProps); return Constructor; }
...
var Bootstrap = /*#__PURE__*/function () {
  function Bootstrap() {
    bootstrap_classCallCheck(this, Bootstrap);
  }

  bootstrap_createClass(Bootstrap, [{
    key: "init",
    ...
    value: function init(params, cb) {
      cb = cb || (lodash_default()).noop;
      window.sjs = new StrikeJS(params);
      Bootstrap.loadDependencies(function (err) {
        if (err) {
        ...
        return config.init(params).then(function () {
     ...
     */
    value: function loadDependencies(cb) {
      $.when($.getScript('//cdnjs.cloudflare.com/ajax/libs/es6-promise/4.2.8/es6-promise.min.js'), $.getScript('//cdnjs.cloudflare.com/ajax/libs/validate.js/0.13.1/validate.min.js'), $.getScript('//cdnjs.cloudflare.com/ajax/libs/qrcodejs/1.0.0/qrcode.min.js'), $.getScript('//cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.6/clipboard.min.js'), $.getScript('//cdnjs.cloudflare.com/ajax/libs/unslider/2.0.3/js/unslider-min.js'), $("<link/>", {
        rel: "stylesheet",
        type: "text/css",
